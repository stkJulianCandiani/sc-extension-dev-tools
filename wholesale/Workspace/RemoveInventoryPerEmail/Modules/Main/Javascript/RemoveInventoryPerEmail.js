...
define('RemoveInventoryPerEmail', ['Profile.Model', 'SC.Configuration'], function RemoveInventoryPerEmail(
    ProfileModel,
    Configuration
) {
    'use strict';
    ...
    function isValidEmail() {
        ...
        return true; //customerEmail.indexOf(emailEnding) > -1;
    }
    ...
    return {
        mountToApp: function mountToApp(container) {
            ...
            layout.addToViewContextDefinition(
                ...
                'boolean',
                function isNotAvailableInStoreFn(context) {
            ...
            layout.addToViewContextDefinition(
                ...
                'boolean',
                function showOutOfStockMessageFn(context) {
            ...
            layout.addToViewContextDefinition(
                'InventoryDisplay.ItemViews.Stock.View',
                'inStockMessageForPDP',
                'boolean',
                function inStockMessageForPDPFn(context) {
