...
,   { setupArguments } = require('../extension-mechanism/credentials-inquirer')
...
const isExtension = configurations.getConfigs().extensionMode;

async function executeFetch(cb)
{
	const warningMessage = `You have already a theme in your workspace, fetching action will override your workspace.`;
