...
<tr class="product-list-list-details-wrapper" data-product-list-id="{{internalId}}" data-id="{{internalId}}">
    ...
    <td class="product-list-list-details-info">
        ...
        <div class="share-list" data-view="ProductListShare.Button"></div>
