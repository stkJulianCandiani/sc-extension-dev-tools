<tr id="{{lineId}}" data-item-id="{{itemId}}" data-type="order-item" {{#if showGeneralClass}} class="{{generalClass}}" {{/if}} >
	...
	<td class="transaction-line-views-cell-actionable-table-middle">
        ...
        {{#if model.showTroopNumeral}}
            <div class="transaction-line-views-cell-actionable-summary">
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate 'Numeral:'}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.troopNumeralSelection}}</span>
                </p>
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate 'Numeral Cost:'}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.troopNumeralCost}}</span>
                </p>
            </div>
        ...
        {{#if model.council}}
            <div class="transaction-line-views-cell-actionable-summary">
                <p>
                    <span class="transaction-line-views-quantity-amount-label">{{translate 'Council: '}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amoun">{{model.council}}</span>
                </p>
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate 'Council Cost:'}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.councilCost}}</span>
                </p>
            </div>
        {{/if}}
        {{#if model.flagFee}}
          <div class="transaction-line-views-cell-actionable-summary">
                <p>
                    <span class="transaction-line-views-quantity-amount-label">{{translate 'American Flag Patch'}}</span>
                </p>
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate 'Flag Cost:'}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.flagFee}}</span>
                </p>
            </div>
        {{/if}}
		{{#if model.troopCrestFee}}
          <div class="transaction-line-views-cell-actionable-summary">
                <p>
                    <span class="transaction-line-views-quantity-amount-label">{{model.troopCrestName}}</span>
                </p>
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate 'Troop Crest Patch Cost:'}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.troopCrestFee}}</span>
                </p>
            </div>
        {{/if}}
        {{#if model.insigniaPinFee}}
          <div class="transaction-line-views-cell-actionable-summary">
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate '$(0) Cost:' line.insigniaPinName}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.insigniaPinFee}}</span>
                </p>
            </div>
        {{/if}}
        {{#if model.membershipPinFee}}
         	<div class="transaction-line-views-cell-actionable-summary">
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate '$(0) Cost:' line.membershipPinName}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.membershipPinFee}}</span>
                </p>
            </div>
        {{/if}}
		{{#if line.trefoilFee}}
			<div class="transaction-line-views-cell-actionable-summary">
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate '$(0) Cost:' line.trefoilName}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.trefoilFee}}</span>
                </p>
            </div>
		{{/if}}
		{{#if model.showMonogram}}
            <div class="transaction-line-views-cell-actionable-summary">
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate 'Monogram:'}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.monogramSelection}}</span>
                </p>
                <p>
		            <span class="transaction-line-views-quantity-amount-label">{{translate 'Monogramming Fee:'}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amount">{{model.monogramCost}}</span>
                </p>
            </div>
        ...
        {{#if model.serviceFee}}
            <div class="transaction-line-views-cell-actionable-summary">
                <p>
                    <span class="transaction-line-views-quantity-amount-label">{{translate 'Service Cost: '}}</span>
                    <span class="transaction-line-views-quantity-amount-item-amoun">{{model.serviceFee}}</span>
                </p>
            </div>
        {{/if}}
        {{#if model.aggregatedTotal}}
                <div class="transaction-line-views-cell-actionable-summary">
                    <p>
                        ...
                        <span class="transaction-line-views-quantity-amount-item-amount">{{model.aggregatedTotal}}</span>
                    </p>
                </div>
        {{/if}}
