define('Newsletter.ServiceController.Site', [
    ...
    'ReCaptcha.Adapter',
    'underscore'
], function NewsletterServiceControllerSite(
    ...
    return _.extend(NewsletterServiceController, {
        post: function NewsletterPost() {
            ...
            return NewsletterModel.subscribe(this.data.email, this.data.firstname, this.data.lastname, this.data.birth, this.data.zipcode);
        }
    });
});
